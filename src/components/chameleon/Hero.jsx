      ...
      <div
        ...
        <div
          ...
          <Image
            ...
            className="absolute inset-0 h-full w-full object-cover"
          />
          <span className="pointer-events-none absolute bottom-24 right-16 z-10 flex items-center justify-center border-2 border-black px-6 py-2 text-[18px] font-medium tracking-[0.35em] text-black">
            AFTER
          </span>
        </div>
